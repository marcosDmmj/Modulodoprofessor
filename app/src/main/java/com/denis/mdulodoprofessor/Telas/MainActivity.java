        ...
        switch(requestCode) {
            case REQUEST_GOOGLE_PLAY_SERVICES:
                if (resultCode != RESULT_OK) {
                    Snackbar.make(getCurrentFocus(), "This app requires Google Play Services. Please install " +
                            "Google Play Services on your device and relaunch this app.", Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
                    //mOutputText.setText(
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        MakeRequestTask(GoogleAccountCredential credential) {
            ...
            mService = new com.google.api.services.calendar.Calendar.Builder(
                    ...
                    .setApplicationName("Módulo professor")
                    .build();
        }
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                Snackbar.make(getCurrentFocus(), "No results returned.", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();

            } else {
                output.add(0, "Data retrieved using the Google Calendar API:");
                Snackbar.make(getCurrentFocus(), TextUtils.join("\n", output), Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
        ...
        protected void onCancelled() {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    Snackbar.make(getCurrentFocus(), "The following error occurred:\n"
                                  + mLastError.getMessage(), Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
                }
            } else {
                Snackbar.make(getCurrentFocus(), "Request cancelled.", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
